                ...
                <td>
                        <table style="margin:0px auto; width:60%; background:#D5D5D5;">
                            ...
                            <tr>
                                ...
                                <td style="font-size:19px;">
                                    <?php echo e($supplier_receive_voucher[0]->amount); ?>

                                </td>
                                <td style="font-size:19px;">
                                    <?php echo e($supplier_receive_voucher[0]->action); ?>
                ...
                <td>
        			<div class="main">
        				<div class="main-center">
        					<form class="" method="post" action="<?php echo e(url('supplier-receiving-voucher-edit-post')); ?>">
        						<?php echo csrf_field(); ?>
        						<input type="hidden" class="form-control" value="<?php echo e($supplier_receive_voucher[0]->id); ?>" name="id"/>
        						...
        						<div class="form-group">
        							<label for="username">Amount</label>
        								<div class="input-group">
        									...
        									<input type="text" class="form-control" name="amount" value="<?php echo e($supplier_receive_voucher[0]->amount); ?>"/>
        								</div>
        						</div>
        							...
        							<label for="username">Status</label>
        								<div class="input-group">
        									...
        									<select name="action" class="form-control">
        									    <option selected value="<?php echo e($supplier_receive_voucher[0]->action); ?>"> <?php echo e($supplier_receive_voucher[0]->action); ?> </option>
