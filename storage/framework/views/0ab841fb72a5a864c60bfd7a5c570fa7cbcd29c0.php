...
<section style="padding:0px;" class="forms">
    <div style="padding-right:50px !important; padding-left:50px !important" class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
            <h1 style="background:#E503D4; padding:10px; text-align:center; color:#fff;"> E X P E N S E  &nbsp; &nbsp;  P A Y M E N T &nbsp; &nbsp;   V O U C H E R   (Debit) Default</h1>
            
                    <div style="padding:0px !important" class="card-body">
                        <?php echo Form::open(['url' => 'sales/321/expense_voucher_debit', 'method' => 'post', 'id'=> 'inputform', 'onsubmit'=>'return monitor()', 'files' => true, 'class' => 'payment-form']); ?>
