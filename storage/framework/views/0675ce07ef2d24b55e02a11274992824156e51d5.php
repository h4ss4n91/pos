    ...
    <div class="container-fluid">
        <div class="card">
            <div style="background:#7c5cc4; padding:10px;" class="card-header mt-2">
                <h1 style="color:#fff;" class="text-center">Expense <?php echo e(trans('file.Account Statement')); ?></h1>
            </div>
            <div class="card-body">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <?php $customers = DB::table('accounts')->where('is_active', true)->where('account_type','=', 'expense')->get(); ?>
                                                                
                                                                    <select class="form-control selectpicker" id="account_id" name="account_id" data-live-search="true" data-live-search-style="begins" title="Select Expense...">
                                                                        ...
                                                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option style="font-weight:bold; font-size:21px;" value="<?php echo e($account->id); ?>"><?php echo e($account->name); ?> <span style="color:red !mportant">()</span> (<?php echo e($account->id); ?>)</option>
              ...
              for(var i=0; i<len; i++){
                ...
                if(status == 1){
                 var tr_str = "<tr style='background:#D8D8D8' id='refinement-menu'>" +
                   ...
                   "<td align='center'><div id='solTitle'><a onClick='openSolution();' id='"+ id +"'> <i class='fa fa-check' aria-hidden='true'></i></a> <span style='display:block; color:red; font-weight:bold;'>"+checked_amount+"</span></td>" +
                 "</tr>";   
              ...
              for(var i=0; i<len; i++){
                ...
                if(status == 1){
                 var tr_str = "<tr style='background:#D8D8D8' id='refinement-menu'>" +
                   ...
                   "<td class='payment' align='center'>" + credit +  "</td>" +
                   "<td class='balance' align='center'>" + currentBalance + "</td>" +
                   "<td align='center'><div id='solTitle'><a onClick='openSolution();' id='"+ (i+1) +"'> <i class='fa fa-check' aria-hidden='true'></i></a> <span style='display:block; color:red; font-weight:bold;'>"+checked_amount+"</span></td>" +
