        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(url('submit_city')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
            ...
            <div class="card">
                ...
                <div style="padding:50px;" class="card-body">
                    ...
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-id="<?php echo e($user->id); ?>">
                                <td><?php echo e($key); ?></td>
                                <td><?php echo e($user->city); ?></td>
                                <td><?php echo e($user->urdu_name); ?></td>
                                <td>
                                          ...
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel"><?php echo e($user->city); ?></h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                  <span aria-hidden="true">&times;</span>
                                                </button>
                                              </div>
                                              <div class="modal-body">
                                                    <form action="<?php echo e(url('update_city')); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="hidden" name="id" value="<?php echo e($user->id); ?>" class="form-control"/>
                                                      <div class="form-group">
                                                        <label for="exampleInputEmail1">City Name (English)</label>
                                                        <input type="text" name="city_name_english" value="<?php echo e($user->city); ?>" class="form-control"/>
                                                      </div>
                                                      <div class="form-group">
                                                        <label for="exampleInputEmail1">City Name (Urdu)</label>
                                                        <input type="text" name="city_name_urdu" value="<?php echo e($user->urdu_name); ?>" class="form-control"/>
                                                      </div>
                                                      <button type="submit" class="btn btn-primary">Submit</button>
                                                    </form>
                                              </div>
