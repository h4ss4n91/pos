...
<div class="rows">
    ...
    <div class="table-responsive">
        ...
        <table id="customer-table" class="table table-striped">
              ...
              <tbody>
                  <?php $__currentLoopData = $customer_receive_voucher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php
                  ...
                  ?>
                        <tr>
                          ...
                          <th style="font-size:19px;" scope="row"><?php if(!$customers->isEmpty()): ?> <?php echo e($customers[0]->company_name); ?> <br/> <?php echo e($customers[0]->name); ?> <span style="font-size:14px !important;"> <?php echo e($customers[0]->city); ?> </span> <?php endif; ?></th>
                          ...
                          <th style="font-size:19px;" scope="row"> <a target="_blank" href="<?php echo e(url('customer-receiving-voucher-edit', $row->id)); ?>"> Edit <?php echo e($row->id); ?></a>| Delete</th>
                        </tr>
