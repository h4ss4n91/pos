            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a  href="#voucher" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-copy"></i><span>Voucher</span></a>
                    <ul  id="voucher" class="collapse list-unstyled">
                      ...
                      ?>
                      <li id="cashInHand-voucher-menu"><a href="{{url('receive-voucher/211/cash_in_hand')}}">Cash In Hand</a></li>
                      ...
                      <li id="customer-voucher-menu"><a href="#customer_voucher" aria-expanded="false" data-toggle="collapse">Customer Vouchers</a>
                        <ul id="customer_voucher" class="collapse list-unstyled">
                            <li id="purchase-voucher-menu"><a href="{{url('customer-receiving-voucher-list')}}">Customers Voucher List</a></li>
                            <li id="purchase-voucher-menu"><a href="{{url('customer-receiving-voucher')}}">Receive Voucher</a></li>
                            <li><a href="{{url('customer-payment-voucher')}}">Payment Voucher</a></li>
                        </ul>
                      </li>
                      ...
                      <li id="supplier-voucher-menu"><a href="#supplier_voucher" aria-expanded="false" data-toggle="collapse">Supplier Vouchers</a>
                        <ul id="supplier_voucher" class="collapse list-unstyled">
                            <li><a href="{{url('supplier-receiving-voucher-list')}}">Suppliers Voucher List</a></li>
                            <li><a href="{{url('supplier-receiving-voucher')}}">Receive Voucher</a></li>
                            <li><a href="{{url('supplier-payment-voucher')}}">Payment Voucher</a></li>
                        </ul>
                      </li>
                      ...
                      <li id="expense-voucher-menu"><a href="#expense_voucher" aria-expanded="false" data-toggle="collapse">Expense Vouchers</a>
                        <ul id="expense_voucher" class="collapse list-unstyled">
                            <li><a href="{{url('expense-receiving-voucher')}}">Receive Voucher</a></li>
                            <li><a href="{{url('expense-payment-voucher')}}">Payment Voucher</a></li>
                        </ul>
                      </li>
                      ...
                      <li id="bank-voucher-menu"><a href="#bank_voucher" aria-expanded="false" data-toggle="collapse">Bank Vouchers</a>
                        <ul id="bank_voucher" class="collapse list-unstyled">
                            <li><a href="{{url('bank-receiving-voucher')}}">Receive Voucher</a></li>
                            <li><a href="{{url('bank-payment-voucher')}}">Payment Voucher</a></li>
                        </ul>
                      </li>
                      <!-- li id="receive-voucher-menu"><a href="{{url('receive-voucher')}}">OLD Receive Voucher</a></li -->
                      <!-- li id="purchase-voucher-menu"><a href="{{url('purchase-voucher')}}">Supplier Voucher</a></li>
                      <li id="expense-voucher-menu"><a href="{{url('expense-voucher')}}">Expense Voucher</a></li>
                      <li id="bank-voucher-menu"><a href="{{url('bank-voucher')}}">Bank Voucher</a></li -->
                      <li id="general-journal-menu"><a href="{{url('general-journal')}}">General journal</a></li>
                    </ul>
                </li>
              ...
              <li class=""><a href="#account" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>{{trans('file.Accounting')}}</span></a>
                <ul id="account" class="collapse list-unstyled ">
                  @if($index_permission_active)
                  <li id="account-list-menu"><a href="{{route('accounts.index')}}">{{trans('file.Account List')}}</a></li>
                  <li id="account-customer-statement"><a href="{{url('accounts/customer_statement')}}">Customer Statement</a></li>
                  <li id="account-customer-statement"><a href="{{url('accounts/supplier_statement')}}">Supplier Statement</a></li>
                  <li id="account-customer-statement"><a href="{{url('accounts/expense_statement')}}">Expense Statement</a></li>
                  <li id="account-customer-statement"><a href="{{url('accounts/bank_statement')}}">Bank Statement</a></li>
    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; {{$general_setting->site_title}} | {{trans('file.Developed')}} {{trans('file.By')}} <a target="_blank" href="https://creativedrop.com" class="external">Creative Drop</a></p>
            </div>
          </div>
        </div>
      </footer>
