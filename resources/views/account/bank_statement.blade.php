    ...
    <div class="container-fluid">
        <div class="card">
            <div style="background:#7c5cc4; padding:10px;" class="card-header mt-2">
                <h1 style="color:#fff;" class="text-center">Bank {{trans('file.Account Statement')}}</h1>
            </div>
            <div class="card-body">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 form-group">
                                                                    <select class="form-control selectpicker" id="account_id" name="account_id" data-live-search="true" data-live-search-style="begins" title="Select Bank...">
                                                                        @php $customers = DB::table('accounts')->where('is_active', true)->where('account_type', '=', 'bank')->get(); @endphp
