    ...
    <div class="container-fluid">
        <div class="card">
            <div style="background:#7c5cc4; padding:10px;" class="card-header mt-2">
                <h1 style="color:#fff;" class="text-center">Expense {{trans('file.Account Statement')}}</h1>
            </div>
            <div class="card-body">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                @php $customers = DB::table('accounts')->where('is_active', true)->where('account_type','=', 'expense')->get(); @endphp
                                                                    ...
                                                                    <select class="form-control selectpicker" id="account_id" name="account_id" data-live-search="true" data-live-search-style="begins" title="Select Expense...">
                                                                        ...
                                                                        @foreach($customers as $account)
                                                                            <option style="font-weight:bold; font-size:21px;" value="{{$account->id}}">{{$account->name}} <span style="color:red !mportant">()</span> ({{$account->id}})</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                              </div>
